...
Eine Alternative besteht darin, das Paket `DotMaps` zu verwenden, mit dem wir die Werte schrittweise hinzufügen können. 

```{julia}
using DotMaps
```

Hier wird eine Variable vom Typ `DotMap` erzeugt und danach mit Werten belegt.
